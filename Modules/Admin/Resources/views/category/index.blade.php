...
@include("admin::category.breadrum")
    ...
    <div class="table-responsive">
           <h2>Quản lý danh mục ({{isset($total)?$total:''}}) <a  href="{{route('admin.get.create.category')}}" class="float-right"><i class="fas fa-plus-circle"></i></a></h2> 
                  ...
                  <?php switch ($category->type) {
                            case '9':
                             ...
                             case '6':
                              { ?>
                                  <p>Sản phẩm</p>
                                  <a href="">link quản lý sản phẩm</a>
                                  <?php
                                  break;
                              } 
